  ...
  <ul class="navbar-nav mx-auto">
    <li class="nav-item">
      <a class="nav-link" href="/index.html">Login / Signup</a>
		...
		<?$id = $_GET['id'];?>
		<div class="container">
		<form name="Input" action="userdetail.php?id=<?=$id?>'" method="POST">
			...
			Parent Phone:<input class="form-control" type="text" name="parent_phone"><br>
		...
		<?php
			...
			SET name ='".$Name."', age='".$Age."',address='".$address."',phone_number='".$phone_number."',email= '".$email."', parent_phone='".$parent_phone."',birthday= '".$birthday."', paypal_account='".$paypal_account."' WHERE user_id ='".$id;		
